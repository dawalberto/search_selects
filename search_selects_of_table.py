...
# Print the files
all_selects = open('all_selects_of_table.txt', mode='w+', encoding='utf8')
without_relationship = open('without_relationship_of_table.txt', mode='w+', encoding='utf8')
with_relationship = open('with_relationship_of_table.txt', mode='w+', encoding='utf8')
    ...
    for num, line in enumerate(f, 1):
      ...
      if found_select:
        ...
        if line.upper().rfind('FROM') > -1:
          ...
          if line.rfind(table, index_of_from) > -1:
            is_table = True
        if line.rfind(';') > -1:
          found_select = False
          if is_table:
